          ...
          explanations: [
            {
              ...
              explanation: "Breaking down this event listener setup:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>document</code> = The entire web page (HTML document)</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>getElementById()</code> = Method to find a specific HTML element by its ID</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>addTaskBtn</code> = The ID of our button from the HTML</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>addEventListener()</code> = Method that waits for user interactions</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>click</code> = The type of interaction we're waiting for</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>function()</code> = The code that runs when the click happens</li><li>This connects user actions to code responses</li></ul>",
            ...
            },
            {
              ...
              explanation: "Understanding variable creation and DOM access:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>const</code> = Creates a new variable (a named container for data)</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>input</code> = The name we're giving to our variable</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>=</code> = Assignment operator (puts the value on the right into the variable on the left)</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>document.getElementById()</code> = Finds the HTML element with ID 'taskInput'</li><li>This creates a reference to the input field so we can work with it</li><li>Variables let us store and reuse values throughout our code</li></ul>",
            ...
            },
            {
              ...
              explanation: "Creating another variable for form data access:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>const prioritySelect</code> = Creates a variable named 'prioritySelect'</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>getElementById('prioritySelect')</code> = Finds the dropdown menu in the HTML</li><li>This follows the same pattern as the input field variable</li><li>Each form element needs its own variable to access its data</li><li>Dropdown menus (select elements) contain the user's choice</li><li>We'll use this variable later to get the selected priority level</li></ul>",
            ...
            },
            {
              ...
              explanation: "Creating a third variable for date input:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>const dueDateInput</code> = Variable to store reference to the date picker</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>getElementById('dueDateInput')</code> = Finds the date input field in HTML</li><li>This completes our collection of form element references</li><li>Date inputs are special HTML elements that show a calendar picker</li><li>We need all three variables (text, priority, date) to create complete tasks</li><li>This pattern of getting elements first is common in JavaScript</li></ul>",
            ...
            },
            {
              ...
              explanation: "Understanding conditional logic and validation:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>if</code> = JavaScript keyword that creates a conditional check</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>!dueDate</code> = Checks if dueDate is empty or null (! means 'not' or 'opposite of')</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>alert()</code> = Shows a pop-up message to the user</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>return</code> = Stops the function from continuing (exits early)</li><li>This prevents task creation if no due date was selected</li><li>If statements let programs make decisions based on data</li><li>Validation protects against incomplete or invalid data</li></ul>",
            ...
            },
            {
              ...
              explanation: "Understanding function calls and return values:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>const priorityColor</code> = Creates a new variable to store the result</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>getPriorityColor()</code> = Calls a function (a reusable piece of code)</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>priority</code> = The parameter we're passing to the function (the priority level)</li><li>Functions take input (priority) and return output (CSS class name)</li><li>This function converts <code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>High</code> to <code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>priority-high</code> for CSS styling</li><li>Functions help organize code and avoid repetition</li><li>The returned value gets stored in the priorityColor variable</li></ul>",
            ...
            },
            {
              ...
              explanation: "Understanding date processing and formatting:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>const formattedDate</code> = Variable to store the formatted date</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>new Date()</code> = Creates a JavaScript Date object from the input date</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>dueDate</code> = The raw date value from the date picker</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>.toLocaleDateString()</code> = Method that formats dates for display</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>en-UK</code> = Parameter specifying UK date format (DD/MM/YYYY)</li><li>This converts <code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>2025-07-25</code> to <code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>25/07/2025</code> for better readability</li><li>Date objects have many built-in methods for formatting and calculations</li></ul>",
            ...
            },
            {
              ...
              explanation: "Understanding DOM manipulation and element insertion:<ul><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>taskList</code> = The variable holding reference to the task container</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>.appendChild()</code> = Method that adds a child element inside a parent</li><li><code class='bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs font-mono'>newTask</code> = The complete task card element we created</li><li>This physically adds the new task to the visible page</li><li>The browser immediately shows the new task in the list</li><li>DOM manipulation changes the page structure in real-time</li><li>This is how JavaScript makes web pages dynamic and interactive</li></ul>",
