          ...
          explanations: [
            {
              ...
              explanation: "This line sets up an event listener that waits for user clicks. Here's what each part does:<br/><br/><strong>document</strong> - The entire web page<br/><strong>getElementById('addTaskBtn')</strong> - Finds the button with ID 'addTaskBtn'<br/><strong>addEventListener('click', ...)</strong> - Waits for click events on that button<br/><strong>function() { ... }</strong> - The code that runs when clicked<br/><br/>Think of it like: 'Hey browser, when someone clicks the Add Task button, run this code!'",
            ...
            },
            {
              ...
              explanation: "This creates a variable to store a reference to the text input field:<br/><br/><strong>const</strong> - Creates a new variable (like a named box to store things)<br/><strong>input</strong> - The name we're giving our variable<br/><strong>=</strong> - Assigns the value on the right to the variable on the left<br/><strong>document.getElementById('taskInput')</strong> - Finds the input field in the HTML<br/><br/>Now we can use 'input' to work with that text field throughout our code.",
            ...
            },
            {
              ...
              explanation: "This creates a variable to access the priority dropdown menu:<br/><br/><strong>const prioritySelect</strong> - Creates a variable named 'prioritySelect'<br/><strong>getElementById('prioritySelect')</strong> - Finds the dropdown in the HTML<br/><br/>This follows the same pattern as the input field - we get a reference to the form element so we can read what the user selected. Each form field needs its own variable.",
            ...
            },
            {
              ...
              explanation: "This creates a variable for the date picker field:<br/><br/><strong>const dueDateInput</strong> - Variable to store the date picker reference<br/><strong>getElementById('dueDateInput')</strong> - Finds the date input in the HTML<br/><br/>Now we have references to all three form fields (text, priority, date). This 'get elements first' pattern is very common in JavaScript - gather your tools before you use them!",
            ...
            },
            {
              ...
              explanation: "This is validation - checking the user entered a due date before proceeding:<br/><br/><strong>if (!dueDate)</strong> - 'If there's no due date...'<br/><strong>alert(...)</strong> - Show an error message to the user<br/><strong>return</strong> - Stop here, don't create the task<br/><br/>The exclamation mark (!) means 'not' or 'opposite of'. So this reads: 'If NOT dueDate (if it's empty), show an error and stop'. This prevents creating incomplete tasks.",
            ...
            },
            {
              ...
              explanation: "This calls a helper function to determine what color the priority badge should be:<br/><br/><strong>getPriorityColor(priority)</strong> - Calls a function with the priority level<br/><strong>const priorityColor</strong> - Stores the result in a new variable<br/><br/>Functions are like little machines: you put something in (like 'High') and get something out (like 'priority-high'). This function converts priority levels into CSS class names for styling the colored badges.",
            ...
            },
            {
              ...
              explanation: "This converts the raw date into a user-friendly format:<br/><br/><strong>new Date(dueDate)</strong> - Creates a JavaScript date object<br/><strong>.toLocaleDateString('en-UK')</strong> - Formats it for UK users<br/><strong>const formattedDate</strong> - Stores the result<br/><br/>This transforms '2025-07-25' (computer format) into '25/07/2025' (human-readable UK format). JavaScript's Date object has many built-in formatting options.",
            ...
            },
            {
              ...
              explanation: "This adds the new task to the page so users can see it:<br/><br/><strong>taskList.appendChild(newTask)</strong> - Adds the new task element to the task container<br/><br/>Think of it like putting a new item into a shopping basket. The 'taskList' is the container, and 'newTask' is the new item we're adding. The browser immediately shows this change on the page. This is called DOM manipulation - changing the page structure in real-time.",
